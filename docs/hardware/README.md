...
board profile、配線、matrix 座標、touch-panel layout note を置きます。

まず見る文書:

- [new-board-config-guide.md](new-board-config-guide.md): 新しい基板 profile / config を追加する手順
- [board-profiles.md](board-profiles.md): `ver1.0` / `ver0.1` board profile
...
- [board-profiles.md](board-profiles.md)
- [charlieplex-specification.md](charlieplex-specification.md)
- [complete-matrix-coordinates.md](complete-matrix-coordinates.md)
- [hardware-ports-buzzer-ir-design.md](hardware-ports-buzzer-ir-design.md)
...
- [../daemon/specs/spid/mouse-sensor-plan.md](../daemon/specs/spid/mouse-sensor-plan.md): SPI mouse sensor / `spid` daemon の設計、環境変数、実機確認。
