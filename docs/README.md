...
| 現在の決定、理由、他案・関連制約 | [policy/adr/README.md](policy/adr/README.md) |
...
| PID待ちと開発を分離するrelease channel / RC昇格方針 | [ops/release-channel-policy.md](ops/release-channel-policy.md) |
