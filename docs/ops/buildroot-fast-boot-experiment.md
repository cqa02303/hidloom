...
Windows image hostから取得できるよう、GitHub prerelease
[buildroot-m1-20260711](https://github.com/cqa02303/hidloom/releases/tag/buildroot-m1-20260711)
へ raw `sdcard.img`、圧縮版 `hidloom-buildroot-m1-20260711.img.zst`、両方の
SHA-256 file を置いた。Raspberry Pi Imager へ直接渡す場合は raw `sdcard.img` を使う。
圧縮版は転送量を減らす用途で、展開後の image hash は上記 raw SHA-256 と照合する。
...
- GitHub prerelease
  [buildroot-m2-20260711](https://github.com/cqa02303/hidloom/releases/tag/buildroot-m2-20260711)
  に raw image、30 MiB圧縮版、両checksumを公開し、圧縮assetのdownload verifyも通過した。
  raw image SHA-256 は
...
- [buildroot-m3-20260711](https://github.com/cqa02303/hidloom/releases/tag/buildroot-m3-20260711)
  は旧asset/tagを削除して修正版へ置換した。
