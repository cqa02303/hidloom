...
Final gates:
  python3 $SOURCE/tools/package/build_profile_release_bundle.py verify $OUTPUT --require-hardware-pass
  python3 $SOURCE/tools/package/build_profile_release_bundle.py verify $OUTPUT --require-publication-ready
EOF
