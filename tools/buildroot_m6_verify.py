...
def main() -> None:
    ...
    required = [
        ...
        target / "usr/share/hidloom/daemon/logicd/delegate_protocol.py",
        target / "usr/share/hidloom/daemon/logicd/input_session.py",
        target / "usr/share/hidloom/daemon/logicd/keymap_coordinator.py",
        target / "usr/share/hidloom/daemon/logicd/runtime_json.py",
