...
- Source base commit: `0a5b9e0ec449a85da5aa85476d2fc88c912b13dc`
- Source mode: `clean-head`
- Publishable source: `true`
- Selected source snapshot: `556b9a0a268ec2b47fe79129d518c6d2275b8dba9dd3db170903992c75b1b2c9`
- Files: 1182
...
- `warn` `credential_word` `docs/ops/failure-patterns.md:490` `documentation_security_keyword` — `- recovery: `--rewrite-retired-keys`のdry-runでkey mappingだけを確認し、operator承認後に明示token付き`--apply`を使う。atomic replaceでmode `0600`とvalue byteを維持し、secret-bearing backupやcompatibility aliasを作らない。`
