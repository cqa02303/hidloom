...
- Source base commit: `0bf20462a2c4fa2e98d26bb7f11460c0abe00457`
- Source mode: `clean-head`
- Publishable source: `true`
- Selected source snapshot: `7f152b6f91f2e2ed09b7bb578efe55c08f4f4fe45b8e77ebb572da1b837397ad`
- Files: 1182
...
- `warn` `credential_word` `docs/ops/failure-patterns.md:517` `documentation_security_keyword` — `- recovery: `--rewrite-retired-keys`のdry-runでkey mappingだけを確認し、operator承認後に明示token付き`--apply`を使う。atomic replaceでmode `0600`とvalue byteを維持し、secret-bearing backupやcompatibility aliasを作らない。`
