...
def main() -> None:
    with tempfile.TemporaryDirectory() as temporary:
        ...
        assert manifest["schema"] == "hidloom.profile-package-release.v2"
        ...
        internal_blocked = subprocess.run(
            [
                "python3",
                str(export / "tools/package/build_profile_release_bundle.py"),
                "verify",
        ...
        assert internal_blocked.returncode != 0
        assert "public-build-provenance-missing" in internal_blocked.stderr
