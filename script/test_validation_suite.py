...
TESTS = [
    ...
    "script/test_public_release_mapping.py",
    ...
    "script/test_keymap_coordinator.py",
    "script/test_keymap_coordinator_native.py",
    ...
    "script/test_interaction_source_identity.py",
    "script/test_control_owner_sessions.py",
    ...
    "script/test_http_input_session.py",
    "script/test_http_native_input_session.py",
    "script/test_http_runtime_config.py",
    ...
    "script/test_rpi_os_early_native_initramfs_tool.py",
    "script/test_rpi_os_early_input_handoff_tool.py",
    ...
    "script/test_python_keyboard_route_ownership.py",
    "script/test_logicd_usbd_report_broker_backend.py",
    "script/test_logicd_core_rs_tool.py",
    "script/test_native_owner_protocol.py",
    "script/test_native_delegate_backlog.py",
    "script/test_native_delegate_ack_ownership.py",
    ...
    "script/test_mcp_native_owner.py",
    ...
    "script/test_device_profile_reconciliation.py",
    "script/test_profile_deploy_order.py",
