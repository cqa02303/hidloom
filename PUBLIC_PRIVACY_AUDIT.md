...
- `CQA02303v5.png`: png
- `CQA02303v5_switchLayouts9x10.png`: png
- `daemon/http/static/android-chrome-192x192.png`: png
- `daemon/http/static/android-chrome-512x512.png`: png
- `daemon/http/static/apple-touch-icon.png`: png
...
- `docs/gallery/WebUI/04-keycode-picker.png`: png
- `docs/gallery/WebUI/05-led-host-lock-settings.png`: png
- `docs/gallery/WebUI/06-led-layer-overlay-colors.png`: png
- `docs/gallery/WebUI/07-led-effect-settings.png`: png
- `docs/gallery/WebUI/08-oled-editor.png`: png
- `docs/gallery/WebUI/09-script-editor-placeholder.png`: png
- `docs/gallery/WebUI/10-script-editor-ip-display.png`: png
- `docs/gallery/WebUI/11-interaction-morse-editor.png`: png
